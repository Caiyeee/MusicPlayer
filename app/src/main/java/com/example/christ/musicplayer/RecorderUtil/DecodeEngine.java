...
import com.example.christ.musicplayer.vavi.sound.pcm.resampling.ssrc.SSRC;
...
public class DecodeEngine {
    ...
    private boolean decodeMusicFile(String musicFileUrl, String decodeFileUrl, int startSecond,
        ...
        try {
            ...
            Log.e("解码器configure出错", e.toString());
            return false;
        }
...
//                }
                ...
                Log.e("getDecodeData异常", e.toString());
            }
        }
        ...
        if (bufferedOutputStream != null) {
            try {
                ...
                Log.e("关闭bufferedOutputStream", e.toString());
            }
        }
